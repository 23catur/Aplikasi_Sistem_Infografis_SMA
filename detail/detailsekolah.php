    ...
    <section id="cta" class="cta">
      <div class="container">
        ...
        <div class="text-center" data-aos="zoom-in">
          <h3>SIG</h3>
          <p> Detail Sekolah Menengah Negeri di Kota Makassar</p>
        ...
        <div class="col-md-12">
          <div class="panel panel-info panel-dashboard">
            <div class="panel-heading centered">
              <h2 class="panel-title"><strong> - <?php echo 'Data SMA' ?> - </strong></h2>
            </div>
            <div class="panel-body">
              ...
              <tbody>
              <?php
                $data = file_get_contents('http://localhost/sis-sma/ambildata.php');
                $no=1;
